...
import { addFooterImage } from "../Redux/Admin/Actions";
...
const mapDispatchToProps = (dispatch) => {
  return {
    addFooterImage: (image) => dispatch(addFooterImage(image)),
  };
};

const FooterImage = ({ addFooterImage }) => {
  ...
  return (
    <div className="mt4">
      <Form onFinish={finished} {...layout} form={form}>
        <Form.Item name="imageUrl" label="Footer Image">
...
export default connect(null, mapDispatchToProps)(FooterImage);
